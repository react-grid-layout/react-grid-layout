...
module.exports.utils = __webpack_require__(6);
module.exports.Responsive = __webpack_require__(39).default;
module.exports.Responsive.utils = __webpack_require__(18);
module.exports.WidthProvider = __webpack_require__(40).default;
...
typeof window !== "undefined" && (window.React = _react2.default); // for devtools

module.exports = function (Layout) {
  var ExampleLayout = function (_React$Component) {
    _inherits(ExampleLayout, _React$Component);

    function ExampleLayout() {
      var _temp, _this, _ret;

      _classCallCheck(this, ExampleLayout);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { layout: [] }, _this.onLayoutChange = function (layout) {
        _this.setState({ layout: layout });
      }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    ExampleLayout.prototype.stringifyLayout = function stringifyLayout() {
      return this.state.layout.map(function (l) {
        return _jsx('div', {
          className: 'layoutItem'
        }, l.i, _jsx('b', {}, void 0, l.i), ': [', l.x, ', ', l.y, ', ', l.w, ', ', l.h, ']');
      });
    };

    ExampleLayout.prototype.render = function render() {
      return _jsx('div', {}, void 0, _jsx('div', {
        className: 'layoutJSON'
      }, void 0, 'Displayed as ', _jsx('code', {}, void 0, '[x, y, w, h]'), ':', _jsx('div', {
        className: 'columns'
      }, void 0, this.stringifyLayout())), _jsx(Layout, {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    _reactDom2.default.render(_react2.default.createElement(ExampleLayout, gridProps), contentDiv);
  });
};
...
var _cloneElement = __webpack_require__(37);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(12),p=__webpack_require__(13);__webpack_require__(9);var r=__webpack_require__(8);
...
var _reactResizable = __webpack_require__(36);
...
*/
var aa=__webpack_require__(0);__webpack_require__(9);var l=__webpack_require__(28),n=__webpack_require__(12),ba=__webpack_require__(29),ca=__webpack_require__(8),da=__webpack_require__(13),ea=__webpack_require__(30),fa=__webpack_require__(31),ha=__webpack_require__(34),ia=__webpack_require__(35);
...
module.exports.Resizable = __webpack_require__(17).default;
module.exports.ResizableBox = __webpack_require__(38).default;
...
var _Resizable = __webpack_require__(17);
...
var _responsiveUtils = __webpack_require__(18);

var _ReactGridLayout = __webpack_require__(14);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./example-styles.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./example-styles.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
