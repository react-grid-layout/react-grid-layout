      ...
      (function(t, n) {
        ...
        (Yt["[object Float32Array]"] = Yt["[object Float64Array]"] = Yt[
          ...
          (Yt[St] = Yt[_t] = Yt[It] = Yt[Rt] = Yt[Bt] = Yt[Dt] = Yt[jt] = Yt[
            Et
          ] = Yt[Tt] = Yt[zt] = Yt[kt] = Yt[Nt] = Yt[Lt] = Yt[At] = Yt[
            "[object WeakMap]"
          ] = !1);
        ...
        (f.prototype.clear = p),
          ...
          (_.prototype.has = j),
          (_.prototype.set = E),
          (C.prototype.add = C.prototype.push = T),
          (C.prototype.has = z),
          (P.prototype.clear = k),
          ...
          return (
            ...
            (e.prototype.calcWH = function(t) {
              var e = t.height,
                ...
                c = r.minConstraints,
                f = this.calcColWidth(),
                p = c || this.calcConstraints().minConstraints,
                d = p[0],
                h = p[1],
                y = n + o[0],
                g = f + o[0],
                m = Math.round(y / g),
                v = y % g;
              v > this.state.horizonNum && v > d && (m = Math.ceil(y / g)),
                v < this.state.horizonNum &&
                  v < f - d &&
                  (m = Math.floor(y / g)),
                this.setState({ horizonNum: v });
              var b = e + o[1],
                w = s + o[1],
                x = Math.round(b / w),
                S = b % w;
              return (
                S > this.state.verticalNum && S > h && (x = Math.ceil(b / w)),
                S < this.state.verticalNum &&
                  S < s - h &&
                  (x = Math.floor(b / w)),
                this.setState({ verticalNum: S }),
                (m = Math.max(Math.min(m, i - u), 0)),
                (x = Math.max(Math.min(x, a - l), 0)),
                { w: m, h: x }
              );
            }),
            (e.prototype.calcConstraints = function() {
              var t = this.props,
                e = t.cols,
                n = t.x,
                r = t.minW,
                ...
                a = t.maxW,
                i = t.maxH,
                s = this.calcPosition(0, 0, e - n, 0).width,
                u = this.calcPosition(0, 0, r, o),
                l = this.calcPosition(0, 0, a, i);
              return {
                minConstraints: [u.width, u.height],
                maxConstraints: [
                  Math.min(l.width, s),
                  Math.min(l.height, 1 / 0)
                ]
              };
            }),
            ...
            (e.prototype.mixinResizable = function(t, e) {
              var n = this.calcConstraints();
              return l.default.createElement(
                d.Resizable,
                {
                  width: e.width,
                  height: e.height,
                  minConstraints: n.minConstraints,
                  maxConstraints: n.maxConstraints,
