!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function _(t, e, n) {
        return "horizontal" === e ? R(t, n) : O(t, n);
      }
      function O(t, e) {
      ...
      function R(t, e) {
        return [].concat(t).sort(function(t, n) {
          return (e ? t.x < n.x : t.x > n.x) || (t.x === n.x && t.y > n.y)
            ? 1
            : -1;
        });
      }
        ...
        return (
          ...
          (e.prototype.onResize = function(t, e, n, o, a, i) {
            ...
            if (m) {
              ...
              this.props.onResize(f, h, m, S, s, l),
                this.setState({
                  layout: (0, u.compact)(f, this.compactType(), y, c),
                  activeDrag: S
                });
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r, o, a) {
            ...
            this.props.onResizeStop(p, f, d, null, i, s);
            var y = (0, u.compact)(p, this.compactType(), h, l),
              g = this.state.oldLayout;
            this.setState({
              activeDrag: null,
              layout: l ? p.reverse() : p,
              oldResizeItem: null,
              oldLayout: null
            }),
            ...
            return function(r, o) {
              ...
              var l = r.clientX,
                ...
                f =
                  ...
                  -1 === ["e", "w"].indexOf(e);
              p && "w" === e[e.length - 1] && (i = -i),
                f && "n" === e[0] && (s = -s);
              var h = n.state.prevClient;
              (i = h[0] ? (u ? h[0] - l : l - h[0]) : i),
                (s = h[1] ? c - h[1] : s);
              var d = n.state.width + (p ? i : 0),
                y = n.state.height + (f ? s : 0),
                g = d !== n.state.width,
                m = y !== n.state.height;
              if ("onResize" !== t || g || m) {
                var v = n.runConstraints(d, y);
                (d = v[0]), (y = v[1]);
                var b = {};
                if ("onResizeStart" === t)
                  (b.resizing = !0), (b.prevClient = [l, c]);
                else if ("onResizeStop" === t)
                  (b.resizing = !1),
                    (b.slackW = b.slackH = 0),
                    (b.prevClient = [null, null]);
                else {
                  if (d === n.state.width && y === n.state.height) return;
                  (b.width = d), (b.height = y), (b.prevClient = [l, c]);
                }
        ...
        return (
          ...
          (e.prototype.calcNewDimensions = function(t) {
            ...
            return {
              ...
              x: (s = this.state.leftResize ? s + (p - l) : s),
              y: u
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              f = this.calcPosition(0, 0, l, c),
              h = [p.width, p.height],
              d = [f.width, Math.min(f.height, 1 / 0)];
            return o.default.createElement(
              s.Resizable,
              {
                width: e.width,
        ...
        h = (function(t) {
          ...
          return (
            ...
            (e.prototype.componentDidUpdate = function(t) {
              ...
              } else this.onWidthChange(this.props);
            }),
