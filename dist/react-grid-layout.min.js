          ...
          (e.prototype.onDragHandler = function(t) {
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                switch (t) {
                  case "onDragStart":
                    ...
                    var c = l.getBoundingClientRect(),
                      ...
                      p = f.left / e.props.transformScale,
                      h = c.left / e.props.transformScale,
                      d = f.top / e.props.transformScale,
                      y = c.top / e.props.transformScale;
                    (u.left = p - h + l.scrollLeft),
                      (u.top = d - y + l.scrollTop),
                  ...
                  case "onDrag":
                    ...
                    (u.left =
                      e.state.dragging.left + a / e.props.transformScale),
                      (u.top =
                        e.state.dragging.top + i / e.props.transformScale),
                      e.setState({ dragging: u });
                    break;
                  case "onDragStop":
                    if (!e.state.dragging)
                ...
                var g = e.calcXY(u.top, u.left),
                  m = g.x,
                  v = g.y;
                return s.call(e, e.props.i, m, v, {
                  e: n,
                  node: o,
                  newPosition: u
                });
