...
margin: [number, number] | ?Object = [10, 10],


// # of containerPadding. This is a breakpoint -> containerPadding map, e.g. {lg: [10, 10], md: [10, 10], ...} or [10 , 10]
containerPadding: [number, number] | ?Object = [10, 10],
