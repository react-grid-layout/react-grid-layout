...
margin: [number, number] | ?Object = [10, 10] | {lg: [10, 10], md: [10, 10], sm: [10, 10], xs: [10, 10], xxs: [10, 10]},


// # of containerPadding. This is a breakpoint -> containerPadding map, e.g. {lg: [10, 10], md: [10, 10], ...}
containerPadding: [number, number] | ?Object = [10, 10] | {lg: [10, 10], md: [10, 10], sm: [10, 10], xs: [10, 10], xxs: [10, 10]},
