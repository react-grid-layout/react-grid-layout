...
var ReactGridLayout = (function(_React$Component) {
  ...
  ReactGridLayout.prototype.onDrag = function onDrag(i, x, y, _ref2) {
    ...
    this.setState({
      layout: (0, _utils.compact)(layout, (0, _utils.compactType)(), cols),
  ...
  ReactGridLayout.prototype.onResizeStart = function onResizeStart(
    ...
    var e = _ref4.e,
      node = _ref4.node,
      leftResize = _ref4.leftResize;

    var layout = leftResize ? this.state.layout.reverse() : this.state.layout;
    var l = (0, _utils.getLayoutItem)(layout, i);
    if (!l) return;
