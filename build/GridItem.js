...
var GridItem = (function(_React$Component) {
  ...
  GridItem.prototype.calcWH = function calcWH(_ref) {
    ...
    var _props4 = this.props,
      ...
      x = _props4.x,
      y = _props4.y,
      minConstraints = _props4.minConstraints;

    var colWidth = this.calcColWidth();

    var _ref2 = minConstraints || this.calcConstraints().minConstraints,
      horizon = _ref2[0],
      vertical = _ref2[1];
  ...
  GridItem.prototype.calcConstraints = function calcConstraints() {
  ...
  GridItem.prototype.mixinResizable = function mixinResizable(child, position) {
    var constraints = this.calcConstraints();
