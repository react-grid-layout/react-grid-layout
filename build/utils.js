 ...
 */
function synchronizeLayoutWithChildren(initialLayout, children, cols, verticalCompact, breakpoint) {
    ...
    _react2.default.Children.forEach(children, function (child, i) {
        ...
        if (exists) {
            ...
            var grid = child.props['data-grid'][breakpoint] || child.props['data-grid']['lg'];
