...
function setTransform(_ref5 /*:: */) /*: Object*/{
  ...
  // If a custom transform was provided, use it
  if (_customTransform) {
    return {
      transform: _customTransform,
      WebkitTransform: _customTransform,
      MozTransform: _customTransform,
      msTransform: _customTransform,
      OTransform: _customTransform,
      width: `${width}px`,
      height: `${height}px`,
      position: "absolute"
    };
  ...
  // Regular behavior - Replace unitless items with px
