 ...
 */
export function compact(layout: Layout, verticalCompact: boolean, compactItemFn: Function = compactItem): Layout {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l.static) {
      l = compactItemFn(compareWith, l, verticalCompact);
...
export function synchronizeLayoutWithChildren(initialLayout: Layout, children: Array<React.Element>|React.Element,
                                              cols: number, verticalCompact: boolean, compactItemFn: Function = compactItem): Layout {
