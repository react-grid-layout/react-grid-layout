 ...
 */
export function compact(layout: Layout, verticalCompact: boolean, compactItemFn: Function = compactItem, cols: number): Layout {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l.static) {
      l = compactItemFn(compareWith, l, verticalCompact, cols);
 ...
 */
export function compactItem(compareWith: Layout, l: LayoutItem,
                            verticalCompact: boolean, cols: number): LayoutItem { // eslint-disable-line no-unused-vars
  if (verticalCompact) {
...
export function synchronizeLayoutWithChildren(initialLayout: Layout, children: Array<React.Element<any>>|React.Element<any>,
                                              cols: number, verticalCompact: boolean, compactItem: Function): Layout {
  ...
  layout = compact(layout, verticalCompact, compactItem, cols);
