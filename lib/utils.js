 ...
 */
export function compact(layout: Layout, compactType: CompactType, cols: number, maxRows: number): ?Layout {
  ...
  for (let i = 0, len = sorted.length; i < len; i++) {
    ...
    if (!l.static) {
      l = compactItem(compareWith, l, compactType, cols, maxRows);
      if (!l) { return null; }
 ...
 */
export function compactItem(compareWith: Layout, l: LayoutItem, compactType: CompactType, cols: number, maxRows: number): ?LayoutItem {
...
export function synchronizeLayoutWithChildren(initialLayout: Layout, children: ReactChildren,
                                              cols: number, maxRows: number, compactType: CompactType): Layout {
