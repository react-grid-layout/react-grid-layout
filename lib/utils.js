 ...
 */
export function perc(num): string {
    return num * 100 + '%'
}
 ...
 */
export function synchronizeLayoutWithChildren(initialLayout, children, cols, verticalCompact) {
 ...
 */
export function validateLayout(layout, contextName: string): void {
