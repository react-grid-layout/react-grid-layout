...
export function setTransform({ top, left, width, height }: Position, scale: number = 1): Object {
...
export function setTopLeft({ top, left, width, height }: Position, scale: number = 1): Object {
