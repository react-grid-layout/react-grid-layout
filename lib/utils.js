 ...
 * @param  {Number}     [number]        Number of columns
 * @return {Array}      [Layout]        Compacted Layout.
 */
...
/**
 * Get layout items using vertical compacting
 *
 * @param  {Array}   [Layout]       Array of layout objects.
 * @return {Array}   [Layout]       Sorted static items first.
 */
...
/**
 * Get layout items using horizontal compacting
 *
 * @param  {Array}   [Layout]       Array of layout objects.
 * @return {Array}   [Layout]       Sorted static items first.
 */
