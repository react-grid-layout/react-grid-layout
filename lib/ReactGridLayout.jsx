...
export default class ReactGridLayout extends React.Component {
  ...
  static propTypes = {
    ...
    // Rols have a static height, but you can change this based on breakpoints if you like
  ...
  onResize(i:string, w:number, h:number, {e, node}: ResizeEvent) {
    ...
    this.setState({layout: compact(layout, this.compactType(), cols), activeDrag: placeholder});
  }
