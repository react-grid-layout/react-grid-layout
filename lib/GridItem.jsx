...
export default class GridItem extends React.Component<Props, State> {
  static propTypes = {
    ...
    minW: function (props: Props, propName: string) {
      ...
      if (typeof value !== "number" || isNaN(value)) return new Error("minWidth not Number");
    ...
    maxW: function (props: Props, propName: string) {
      const value = props[propName];
      if (typeof value !== "number" || isNaN(value)) return new Error("maxWidth not Number");
    ...
    minH: function (props: Props, propName: string) {
      const value = props[propName];
      if (typeof value !== "number" || isNaN(value)) return new Error("minHeight not Number");
    ...
    maxH: function (props: Props, propName: string) {
      const value = props[propName];
      if (typeof value !== "number" || isNaN(value)) return new Error("maxHeight not Number");
  ...
  // Instance variables for position tracking - avoid state for easier testing with React 18
